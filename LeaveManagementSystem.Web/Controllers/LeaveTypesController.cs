...
namespace LeaveManagementSystem.Web.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        //dependency injection from line 16 to 21
        ...
        {
            // var LeaveType = SELECT * FROM LeaveTypes , same as the line below
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            //@id == Parameterization - key for preventing SQL injection attacks.
            // equivalent to, SELECT * FROM LeaveTypes WHERE Id = @id
            var leaveType = await _context.LeaveTypes
                .FirstOrDefaultAsync(m => m.Id == id);
            if (leaveType == null)
            {
